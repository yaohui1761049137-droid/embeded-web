...
#define PASSWORD_EXPIRE_DAYS  90   /* 3 months validity after each change */
...
/* Gate used by protected CGIs: 0 if session user is in forced-change
 * state (only the change-password CGI may proceed). */
